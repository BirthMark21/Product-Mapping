#!/usr/bin/env python3
"""
Script to add parent_id columns to LOCAL database tables and populate them
This will work on your local master-db instead of remote Supabase
"""
...
def add_parent_id_columns(engine):
    """Add parent_id columns to all LOCAL tables"""
    
    print("🏗️  Adding parent_id columns to LOCAL tables...")
...
def populate_parent_ids(engine, parent_child_map):
    ...
    print("📝 Populating parent_id values in LOCAL database...")
...
def create_parent_products_table(engine, parent_names):
    ...
    print("🏗️  Creating parent_products table in LOCAL database...")
...
def verify_parent_ids(engine):
    ...
    print("🔍 Verifying parent_id population in LOCAL database...")
...
def main():
    """Main function"""
    print("🚀 Adding Parent IDs to LOCAL Database Tables")
    print("=" * 60)
    print("📥 Source: Local master-db (localhost)")
    ...
    try:
        ...
        print("🎯 Your LOCAL tables now have parent-child relationships!")
