#!/usr/bin/env python3
"""
Export parent products from farm_prices_master table
"""
...
def export_parent_products():
    ...
    print("Exporting parent products from farm_prices_master table")
    print("=" * 60)
    ...
    try:
        ...
        with engine.connect() as conn:
            ...
            if df.empty:
                print("ERROR: No parent products found in farm_prices_master table!")
                return
            ...
            # Export to CSV
            output_file = os.path.join(exports_folder, "farm_prices_parent_products.csv")
