#!/usr/bin/env python3
"""
Add parent_product_id to REMOTE farm_prices table in Supabase
Using parent IDs from farm_prices_master table
"""
...
def main():
    """Main function"""
    print("Adding parent_product_id to REMOTE farm_prices table in Supabase")
    ...
    try:
        ...
        add_parent_product_id_to_remote_table(supabase_engine, 'farm_prices', parent_mapping)
        
        # Step 4: Verify assignments
        print("\nVerification Results:")
        print("=" * 40)
        verify_parent_assignments(supabase_engine, 'farm_prices')
        
        print("\nSUCCESS: Parent product ID assignment completed for remote farm_prices!")
