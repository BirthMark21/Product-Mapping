#!/usr/bin/env python3
"""
Export parent products from distribution_center_master table
"""
...
def export_parent_products():
    ...
    print("Exporting parent products from distribution_center_master table")
    print("=" * 60)
    ...
    try:
        ...
        with engine.connect() as conn:
            ...
            if df.empty:
                print("ERROR: No parent products found in distribution_center_master table!")
                return
            ...
            # Export to CSV
            output_file = os.path.join(exports_folder, "distribution_center_parent_products.csv")
