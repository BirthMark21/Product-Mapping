...
def get_distribution_center_products():
    ...
    print("Fetching all products from remote Supabase distribution_center_prices table...")
    print("=" * 60)
...
def main():
    ...
    try:
        # Step 1: Get all products from remote Supabase distribution_center_prices table
