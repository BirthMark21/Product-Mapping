#!/usr/bin/env python3
"""
Export parent products from supermarket_master table
"""
...
def export_parent_products():
    ...
    print("Exporting parent products from supermarket_master table")
    print("=" * 60)
    ...
    try:
        ...
        with engine.connect() as conn:
            ...
            if df.empty:
                print("ERROR: No parent products found in supermarket_master table!")
                return
            ...
            # Export to CSV
            output_file = os.path.join(exports_folder, "supermarket_parent_products.csv")
